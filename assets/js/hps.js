(function (root, factory) {
  ...
  var HPS = function (wrp, options) {
    ...
    var setupControls = function () {
      ...
      //temp
      controlsNode.style.cssText = 'position:fixed;top:0;right:0;z-index:999;color: #0000ff;display: flex;flex-direction: column-reverse;justify-content: space-between;height: 100%;padding: 16px;';
